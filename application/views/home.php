	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 ml-auto align-self-center">
				<div class="feature-content">
					<!-- Feature Title -->
					<h2>Upcoming Event: Brigada Eskwela</a></h2>
					<!-- Feature Description -->
					<p>We have a Brigada Eskwela this coming Thursday at San Rojas Elementary School at August 29, 2022 - 7AM. Please bring your own cleaning materials or donate some if you have plenty. See you there!.</p>
				</div>
				<!-- Testimonial Quote -->
				<div class="testimonial">
					<p>
			...
			<div class="col-lg-6 mr-auto justify-content-center">
				<!-- Feature mockup -->
				<div class="image-content">
					<img class="img-fluid" src="<?php echo base_url(); ?>assets/images/feature/event_02.jpg" alt="ipad">
				</div>
			</div>
		</div>
	</div>
