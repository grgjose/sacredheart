            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    <td id="document_type_"><?php echo $request->document_type; ?></td>
					<td id="document_purpose_>"><?php echo $request->document_purpose; ?></td>
					<td><?php foreach($users as $user){ if($user->user_id == $request->user_id){ echo $user->fname." ".$user->mname." ".$user->lname; break; } } ?></td>
					<td id="age_"><?php echo $request->date_needed; ?></td>
                    <td>
					...
					<td id="date_created_"><?php echo $request->date_created; ?></td>
					<td>
