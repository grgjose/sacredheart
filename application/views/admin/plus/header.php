        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/filed_complaints" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/document_request_types" class="nav-link">
                  <i class="fas fa-info nav-icon"></i>
                  <p>Doc Request Types</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/assistance_request_types" class="nav-link">
                  <i class="fas fa-font nav-icon"></i>
                  <p>Assistance Request Types</p>
                </a>
              </li>
            </ul>
          </li>
